...
import 'image_stickers_controls_style.dart';
...
class _EditableStickerState extends State<EditableSticker> {
  ...
  bool areControlsVisible() {
    return widget.stickerControlsBehaviour ==
        StickerControlsBehaviour.alwaysShow ||
        widget.stickerControlsBehaviour == StickerControlsBehaviour.hideOnTap && !widget.sticker.dragged;
  }
